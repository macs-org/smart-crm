...
Define and ship the smallest standalone version of **Auth + Workspaces** that can be reviewed independently before milestone integration.
...
```txt
apps/mvps/m1.2-auth-workspaces/
```
