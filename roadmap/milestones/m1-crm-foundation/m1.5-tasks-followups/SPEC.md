...
Define and ship the smallest standalone version of **Tasks + Follow-ups** that can be reviewed independently before milestone integration.
...
```txt
apps/mvps/m1.5-tasks-followups/
```
