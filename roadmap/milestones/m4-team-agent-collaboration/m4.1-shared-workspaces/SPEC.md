...
Define and ship the smallest standalone version of **Shared Workspaces** that can be reviewed independently before milestone integration.
...
```txt
apps/mvps/m4.1-shared-workspaces/
```
