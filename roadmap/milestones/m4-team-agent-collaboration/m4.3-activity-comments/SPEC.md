...
Define and ship the smallest standalone version of **Activity + Comments** that can be reviewed independently before milestone integration.
...
```txt
apps/mvps/m4.3-activity-comments/
```
