...
Define and ship the smallest standalone version of **Roles + Permissions** that can be reviewed independently before milestone integration.
...
```txt
apps/mvps/m4.2-roles-permissions/
```
