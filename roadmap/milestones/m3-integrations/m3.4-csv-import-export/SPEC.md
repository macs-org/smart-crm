...
Define and ship the smallest standalone version of **CSV Import/Export** that can be reviewed independently before milestone integration.
...
```txt
apps/mvps/m3.4-csv-import-export/
```
