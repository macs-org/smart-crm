...
Define and ship the smallest standalone version of **Smart Follow-ups** that can be reviewed independently before milestone integration.
...
```txt
apps/mvps/m2.2-smart-followups/
```
