...
Define and ship the smallest standalone version of **Relationship Memory** that can be reviewed independently before milestone integration.
...
```txt
apps/mvps/m2.3-relationship-memory/
```
